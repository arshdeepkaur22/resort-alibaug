...
<div className="py-16 bg-white" id="callus">
  <div className="container mx-auto px-6 max-w-screen-xl">
    ...
    <div className="text-center bg-gray-100 p-6 rounded-lg shadow-md">
      ...
      <p className="text-lg text-gray-500 mt-4">For more information, call at 888088888</p>
    </div>
  </div>
</div>
...
<footer className="bg-[#1a6284] text-white py-6">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-center md:text-right text-sm mt-4 md:mt-0">
            ...
            <p className="mt-1">📞 Call: <a href="tel:8888111654" className="hover:text-amber-300 transition">8888111654</a></p>
          </div>
        </div>
      </footer>
    </div>
